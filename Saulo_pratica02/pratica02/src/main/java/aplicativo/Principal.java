...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Produto produto1 = new Produto("Notebook", 6500.00);
            Produto produto2 = new Produto("Celular", 3000.00);
            Produto produto3 = new Produto("Tablet", 600.00);
            ...
            Cliente cliente1 = new Cliente("Rafeal");
            Cliente cliente2 = new Cliente("Carlos Oliveira");
            Cliente cliente3 = new Cliente("Paulo Miguel"); 
            Cliente cliente4 = new Cliente("Saulo Rodrigues");
